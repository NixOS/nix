...
# --keep-going, FOD hash mismatch, and cancelled-builds tests.
# All require the new daemon (cancelled-and-hash-mismatch-status feature).
...
test "$status" = 102 # hash mismatch
# three "hash mismatch" errors + one "build of ... failed"
