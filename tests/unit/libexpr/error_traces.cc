...
#define ASSERT_TRACE2(args, type, message, context)                         \
    ...
    TEST_F(ErrorTraceTest, genericClosure) {
        ASSERT_TRACE2("genericClosure 1",
                      TypeError,
                      hintfmt("value is %s while a set was expected: %s", "an integer", "1"),
        ...
        ASSERT_TRACE2("genericClosure { startSet = 1; }",
                      TypeError,
                      hintfmt("value is %s while a list was expected: %s", "an integer", "1"),
        ...
        ASSERT_TRACE2("genericClosure { startSet = [{ key = 1;}]; operator = true; }",
                      TypeError,
                      hintfmt("value is %s while a function was expected: %s", "a Boolean", "true"),
        ...
        ASSERT_TRACE2("genericClosure { startSet = [{ key = 1;}]; operator = item: true; }",
                      TypeError,
                      hintfmt("value is %s while a list was expected: %s", "a Boolean", "true"),
                      hintfmt("while evaluating the return value of the `operator` passed to builtins.genericClosure"));

        ASSERT_TRACE2("genericClosure { startSet = [{ key = 1;}]; operator = item: [ true ]; }",
                      TypeError,
                      hintfmt("value is %s while a set was expected: %s", "a Boolean", "true"),
    ...
    TEST_F(ErrorTraceTest, replaceStrings) {
        ASSERT_TRACE2("replaceStrings 0 0 {}",
                      TypeError,
                      hintfmt("value is %s while a list was expected: %s", "an integer", "0"),
        ...
        ASSERT_TRACE2("replaceStrings [ 1 ] [ \"new\" ] {}",
                      TypeError,
                      hintfmt("value is %s while a string was expected: %s", "an integer", "1"),
        ...
        ASSERT_TRACE2("replaceStrings [ \"oo\" ] [ true ] \"foo\"",
                      TypeError,
                      hintfmt("value is %s while a string was expected: %s", "a Boolean", "true"),
        ...
        ASSERT_TRACE2("replaceStrings [ \"old\" ] [ \"new\" ] {}",
                      TypeError,
                      hintfmt("value is %s while a string was expected: %s", "a set", "{ }"),
    ...
    TEST_F(ErrorTraceTest, ceil) {
        ASSERT_TRACE2("ceil \"foo\"",
                      TypeError,
                      hintfmt("value is %s while a float was expected: %s", "a string", "\"foo\""),
    ...
    TEST_F(ErrorTraceTest, getEnv) {
        ASSERT_TRACE2("getEnv [ ]",
                      TypeError,
                      hintfmt("value is %s while a string was expected: %s", "a list", "[ ]"),
    ...
    TEST_F(ErrorTraceTest, filterSource) {
        ...
        ASSERT_TRACE2("filterSource [] ./.",
                      TypeError,
                      hintfmt("value is %s while a function was expected: %s", "a list", "[ ]"),
        ...
        //               TypeError,
        //               hintfmt("value is %s while a Boolean was expected: %s", "an integer", "1"),
    ...
    TEST_F(ErrorTraceTest, attrNames) {
        ASSERT_TRACE2("attrNames []",
                      TypeError,
                      hintfmt("value is %s while a set was expected: %s", "a list", "[ ]"),
    ...
    TEST_F(ErrorTraceTest, removeAttrs) {
        ASSERT_TRACE2("removeAttrs \"\" \"\"",
                      TypeError,
                      hintfmt("value is %s while a set was expected: %s", "a string", "\"\""),
    ...
    TEST_F(ErrorTraceTest, catAttrs) {
        ...
        ASSERT_TRACE2("catAttrs \"foo\" {}",
                      TypeError,
                      hintfmt("value is %s while a list was expected: %s", "a set", "{ }"),
    ...
    TEST_F(ErrorTraceTest, elemAt) {
        ASSERT_TRACE2("elemAt \"foo\" (-1)",
                      TypeError,
                      hintfmt("value is %s while a list was expected: %s", "a string", "\"foo\""),
    ...
    TEST_F(ErrorTraceTest, map) {
        ...
        ASSERT_TRACE2("map 1 [ 1 ]",
                      TypeError,
                      hintfmt("value is %s while a function was expected: %s", "an integer", "1"),
    ...
    TEST_F(ErrorTraceTest, filter) {
        ...
        ASSERT_TRACE2("filter (_: 5) [ \"foo\" ]",
                      TypeError,
                      hintfmt("value is %s while a Boolean was expected: %s", "an integer", "5"),
    ...
    TEST_F(ErrorTraceTest, foldlPrime) {
        ...
        ASSERT_TRACE2("foldl' (a: b: a && b) \"foo\" [ true ]",
                      TypeError,
                      hintfmt("value is %s while a Boolean was expected: %s", "a string", "\"foo\""),
    ...
    TEST_F(ErrorTraceTest, genList) {
        ASSERT_TRACE2("genList 1 \"foo\"",
                      TypeError,
                      hintfmt("value is %s while an integer was expected: %s", "a string", "\"foo\""),
    ...
    TEST_F(ErrorTraceTest, bitAnd) {
        ASSERT_TRACE2("bitAnd 1.1 2",
                      TypeError,
                      hintfmt("value is %s while an integer was expected: %s", "a float", "1.1"),
                      hintfmt("while evaluating the first argument passed to builtins.bitAnd"));

        ASSERT_TRACE2("bitAnd 1 2.2",
                      TypeError,
                      hintfmt("value is %s while an integer was expected: %s", "a float", "2.2"),
    ...
    TEST_F(ErrorTraceTest, substring) {
        ASSERT_TRACE2("substring {} \"foo\" true",
                      TypeError,
                      hintfmt("value is %s while an integer was expected: %s", "a set", "{ }"),
    ...
    TEST_F(ErrorTraceTest, derivationStrict) {
        ...
        ASSERT_TRACE2("derivationStrict { name = \"foo\"; builder = 1; __structuredAttrs = 15; }",
                      TypeError,
                      hintfmt("value is %s while a Boolean was expected: %s", "an integer", "15"),
        ...
        ASSERT_TRACE2("derivationStrict { name = \"foo\"; builder = 1; system = 1; outputs = \"out\"; __contentAddressed = \"true\"; }",
                      TypeError,
                      hintfmt("value is %s while a Boolean was expected: %s", "a string", "\"true\""),
