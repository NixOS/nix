...
#define ASSERT_TRACE2(args, type, message, context)                         \
    ...
    TEST_F(ErrorTraceTest, genericClosure) {
        ...
        ASSERT_TRACE2("genericClosure {}",
                      MissingAttrError,
                      HintFmt("attribute '%s' missing: %s", "startSet", Uncolored("{ }")),
        ...
        ASSERT_TRACE2("genericClosure { startSet = [{ key = 1;}]; operator = true; }",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "a function", "a Boolean", Uncolored(ANSI_CYAN "true" ANSI_NORMAL)),
        ...
        ASSERT_TRACE2("genericClosure { startSet = [{ key = 1;}]; operator = item: true; }",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "a list", "a Boolean", Uncolored(ANSI_CYAN "true" ANSI_NORMAL)),
                      HintFmt("while evaluating the return value of the `operator` passed to builtins.genericClosure"));

        ASSERT_TRACE2("genericClosure { startSet = [{ key = 1;}]; operator = item: [ true ]; }",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "a set", "a Boolean", Uncolored(ANSI_CYAN "true" ANSI_NORMAL)),
        ...
        ASSERT_TRACE2("genericClosure { startSet = [{ key = 1;}]; operator = item: [ {} ]; }",
                      EvalError,
                      HintFmt("attribute '%s' missing: %s", "key", Uncolored("{ }")),
    ...
    TEST_F(ErrorTraceTest, replaceStrings) {
        ASSERT_TRACE2("replaceStrings 0 0 {}",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "a list", "an integer", Uncolored(ANSI_CYAN "0" ANSI_NORMAL)),
        ...
        ASSERT_TRACE2("replaceStrings [ \"oo\" ] [ true ] \"foo\"",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "a string", "a Boolean", Uncolored(ANSI_CYAN "true" ANSI_NORMAL)),
        ...
        ASSERT_TRACE2("replaceStrings [ \"old\" ] [ \"new\" ] {}",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "a string", "a set", Uncolored("{ }")),
    ...
    TEST_F(ErrorTraceTest, ceil) {
        ASSERT_TRACE2("ceil \"foo\"",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "a float", "a string", Uncolored(ANSI_MAGENTA "\"foo\"" ANSI_NORMAL)),
    ...
    TEST_F(ErrorTraceTest, filterSource) {
        ...
        //               TypeError,
        //               HintFmt("expected %s but found %s: %s", "a Boolean", "an integer", "1"),
    ...
    TEST_F(ErrorTraceTest, getAttr) {
        ...
        ASSERT_TRACE2("getAttr \"foo\" {}",
                      EvalError,
                      HintFmt("attribute '%s' missing: %s", "foo", Uncolored("{ }")),
    ...
    TEST_F(ErrorTraceTest, removeAttrs) {
        ASSERT_TRACE2("removeAttrs \"\" \"\"",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "a set", "a string", Uncolored(ANSI_MAGENTA "\"\"" ANSI_NORMAL)),
    ...
    TEST_F(ErrorTraceTest, listToAttrs) {
        ...
        ASSERT_TRACE2("listToAttrs [ {} ]",
                      EvalError,
                      HintFmt("attribute '%s' missing: %s", "name", Uncolored("{ }")),
        ...
        ASSERT_TRACE2("listToAttrs [ { name = \"foo\"; } ]",
                      EvalError,
                      HintFmt("attribute '%s' missing: %s", "value", Uncolored("{ name = " ANSI_MAGENTA "\"foo\"" ANSI_NORMAL "; }")),
                      HintFmt("in a {name=...; value=...;} pair"));
    ...
    TEST_F(ErrorTraceTest, catAttrs) {
        ...
        ASSERT_TRACE2("catAttrs \"foo\" {}",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "a list", "a set", Uncolored("{ }")),
    ...
    TEST_F(ErrorTraceTest, functionArgs) {
        ASSERT_TRACE1("functionArgs {}",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "a function", "a set", Uncolored("{ }")));
    ...
    TEST_F(ErrorTraceTest, elemAt) {
        ASSERT_TRACE2("elemAt \"foo\" (-1)",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "a list", "a string", Uncolored(ANSI_MAGENTA "\"foo\"" ANSI_NORMAL)),
    ...
    TEST_F(ErrorTraceTest, filter) {
        ...
        ASSERT_TRACE2("filter (_: 5) [ \"foo\" ]",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "a Boolean", "an integer", Uncolored(ANSI_CYAN "5" ANSI_NORMAL)),
    ...
    TEST_F(ErrorTraceTest, foldlPrime) {
        ...
        ASSERT_TRACE2("foldl' (a: b: a && b) \"foo\" [ true ]",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "a Boolean", "a string", Uncolored(ANSI_MAGENTA "\"foo\"" ANSI_NORMAL)),
    ...
    TEST_F(ErrorTraceTest, genList) {
        ASSERT_TRACE2("genList 1 \"foo\"",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "an integer", "a string", Uncolored(ANSI_MAGENTA "\"foo\"" ANSI_NORMAL)),
    ...
    TEST_F(ErrorTraceTest, bitAnd) {
        ...
        ASSERT_TRACE2("bitAnd 1 2.2",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "an integer", "a float", Uncolored(ANSI_CYAN "2.2" ANSI_NORMAL)),
    ...
    TEST_F(ErrorTraceTest, substring) {
        ASSERT_TRACE2("substring {} \"foo\" true",
                      TypeError,
                      HintFmt("expected %s but found %s: %s", "an integer", "a set", Uncolored("{ }")),
