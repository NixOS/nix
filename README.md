...
See our [Hacking guide](https://nixos.org/manual/nix/unstable/contributing/hacking.html) for instruction on how to set up a development environment and build Nix from source.
