...
struct Common : AbstractInstallableCommand, SourceExprCommand, virtual MixProfile
{
        ...
        const Path & outputsDir = absPath(".") + "/outputs")
    {
        ...
        for (auto & [installable_, dir_] : redirects) {
            ...
            auto builtPaths = Installable::toStorePaths(
                getDrvStore(), store, Realise::Nothing, OperateOn::Output, {installable});
    ...
    StorePath getShellOutPath(ref<Store> store, ref<Installable> installable)
    {
        ...
        if (path && hasSuffix(path->to_string(), "-env"))
            ...
            return getDerivationEnvironment(store, getDrvStore(), drvPath);
        }
    }
...
struct CmdDevelop : Common, MixEnvironment
{
    ...
    void run(ref<Store> store, ref<Installable> installable) override
    {
        ...
        try {
            ...
            for (auto & path : Installable::toStorePaths(getDrvStore(), store, Realise::Outputs, OperateOn::Output, {bashInstallable})) {
