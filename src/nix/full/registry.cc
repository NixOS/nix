...
struct CmdRegistryAdd : Command, MixEvalArgs, RegistryCommand
{
    ...
    CmdRegistryAdd()
        ...
        , MixEvalArgs(static_cast<Command &>(*this))
    {
...
struct CmdRegistryRemove : Command, RegistryCommand
{
    std::string url;
...
struct CmdRegistryPin : EvalCommand, RegistryCommand
{
    std::string url;
