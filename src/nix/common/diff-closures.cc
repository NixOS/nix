...
struct CmdDiffClosures : virtual DrvCommand, GetRawInstallables, MixDefaultParseInstallableArgs, MixOperateOnOptions
{
    ...
    void run(ref<Store> store) override
    {
        ...
        auto beforePath = Installable::toStorePath(getDrvStore(), store, Realise::Outputs, operateOn, before);
        auto after = parseInstallable(store, _after);
        auto afterPath = Installable::toStorePath(getDrvStore(), store, Realise::Outputs, operateOn, after);
