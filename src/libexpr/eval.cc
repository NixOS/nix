...
EvalState::EvalState(
    ...
    , sDrv(symbols.create("drv"))
    , sLog(symbols.create("log"))
    , sProtected(symbols.create("protected"))
    , sPermissions(symbols.create("__permissions"))
    , sUsers(symbols.create("users"))
    , sGroups(symbols.create("groups"))
