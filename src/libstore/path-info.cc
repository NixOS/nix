...
nlohmann::json
UnkeyedValidPathInfo::toJSON(const StoreDirConfig * store, bool includeImpureInfo) const
{
    using nlohmann::json;
...
void adl_serializer<UnkeyedValidPathInfo>::to_json(json & json, UnkeyedValidPathInfo c)
{
