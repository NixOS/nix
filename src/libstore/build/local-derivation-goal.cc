...
#include "linux/sandbox.hh"
#include "darwin/sandbox.hh"
#include "freebsd/sandbox.hh"
...
{
    return !useChroot || REQUIRES_HASH_REWRITE;
}
...
#if __APPLE__
        specialExecBuilder(builder, args, envStrs);
#else
...
void LocalDerivationGoal::basicChrootSetup(Path &chrootRootDir) {
