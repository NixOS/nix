...
constexpr static const HttpBinaryCacheStoreConfigT<config::SettingInfoWithDefault>
    httpBinaryCacheStoreConfigDescriptions = {
        .narinfoCompression{
            {
...
HttpBinaryCacheStore::HttpBinaryCacheStore(ref<const Config> config)
    : Store{*config}
