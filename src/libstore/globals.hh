...
public:
    ...
    Setting<Strings> substituters{
        ...
        R"(
          ...
          A substituter is an additional [store]{#gloss-store} from which Nix can obtain [store objects](@docroot@/glossary.md#gloss-store-object) instead of building them.
