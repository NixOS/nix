...
public:
    ...
    Setting<bool> useXDGBaseDirectories{
        ...
        R"(
          ...
          If you already have Nix installed and are using [profiles](@docroot@/command-ref/files/profiles.md) or [channels](@docroot@/command-ref/nix-channel.md), you should migrate manually when you enable this option.
