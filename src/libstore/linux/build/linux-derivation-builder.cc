...
/* Mounting binfmt_misc in a userns creates a new binfmt_misc instance and
   ...
   binfmt_misc interpreters from the associated instance. User namespaces
   without an associated binfmt_misc instance use the same instance as its
   parent, if there is one, which may be recursively reusing the instance from
   some further ancestor.
