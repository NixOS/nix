 ...
 *
 *   This class is expected to have a constructor `Foo(const StoreConfig::Params & params)`
 ...
 */
struct StoreConfig : StoreDirConfig, StoreConfigT<config::PlainValue>, SubstituterConfigT<std::optional>
{
