                              ...
                              RemoteStore::Config
{
    ...
    UDSRemoteStoreConfig(const StoreConfig::Params & params)
     ...
     */
    UDSRemoteStoreConfig(std::string_view scheme, std::string_view authority, const StoreConfig::Params & params);
