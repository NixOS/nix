...
VERSIONED_CHARACTERIZATION_TEST(
    ...
    drvOutput_2_8,
    "drv-output-2.8",
    (ServeProto::Version{.major = 2, .minor = 8}),
...
VERSIONED_READ_CHARACTERIZATION_TEST(
    ServeProtoTest, buildResult_2_6, "build-result-2.6", (ServeProto::Version{.major = 2, .minor = 6}), ({
        using namespace std::literals::chrono_literals;
        std::tuple<BuildResult, BuildResult, BuildResult> t{
            BuildResult{.inner{BuildResult::Failure{{
                .status = BuildResult::Failure::OutputRejected,
...
VERSIONED_CHARACTERIZATION_TEST(
    ServeProtoTest, buildResult_2_8, "build-result-2.8", (ServeProto::Version{.major = 2, .minor = 8}), ({
        using namespace std::literals::chrono_literals;
        std::tuple<BuildResult, BuildResult, BuildResult> t{
            BuildResult{.inner{BuildResult::Failure{{
                .status = BuildResult::Failure::OutputRejected,
