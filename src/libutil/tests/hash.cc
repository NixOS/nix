...
namespace nix {
    ...
    TEST(hashString, testKnownMD5Hashes1) {
        ...
        ASSERT_EQ(hash.to_string(HashEncoding::PrefixedBase16), "md5:d41d8cd98f00b204e9800998ecf8427e");
    }
    ...
    TEST(hashString, testKnownMD5Hashes2) {
        ...
        ASSERT_EQ(hash.to_string(HashEncoding::PrefixedBase16), "md5:900150983cd24fb0d6963f7d28e17f72");
    }
    ...
    TEST(hashString, testKnownSHA1Hashes1) {
        ...
        ASSERT_EQ(hash.to_string(HashEncoding::PrefixedBase16),"sha1:a9993e364706816aba3e25717850c26c9cd0d89d");
    }
    ...
    TEST(hashString, testKnownSHA1Hashes2) {
        ...
        auto hash = hashString(HashType::htSHA1, s);
        ASSERT_EQ(hash.to_string(HashEncoding::PrefixedBase16),"sha1:84983e441c3bd26ebaae4aa1f95129e5e54670f1");
    }
    ...
    TEST(hashString, testKnownSHA256Hashes1) {
        ...
        ASSERT_EQ(hash.to_string(HashEncoding::PrefixedBase16),
