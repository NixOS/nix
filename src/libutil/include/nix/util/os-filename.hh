...
public:
     ...
     */
    static const OsFilename & unsafeFromPath(const std::filesystem::path & p)
    {
        // OsFilename is a newtype around std::filesystem::path with
        // the same layout, so this reinterpret_cast is safe.
