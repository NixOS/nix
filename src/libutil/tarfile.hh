...
struct TarArchive
{
    ...
    /// @param compression_method - Primary compression method to use. Empty string means 'all'.
    TarArchive(Source & source, bool raw = false, const std::string & compression_method = "");
