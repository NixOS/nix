...
Nix is far from the only project to try to envision build systems abstractly, and indeed the design of the Nix store is comparable to other such efforts.
